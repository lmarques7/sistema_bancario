...
public class CadastroContas {
   ...
   * válido para realizar o débito porque o método "debitar" da classe Conta já
   * testa essa situação
   * 
   * @param num
   *          Número da conta a ser procurada
  ...
  /**
   * Realiza transferência de valores entre as duas contas a partir dos números
   * das contas passados como parâmetro
   * 
   * @param numOrigem
